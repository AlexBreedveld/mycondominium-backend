use crate::models::vehicle_model::VehicleModel;
use super::*;
...
pub async fn get_vehicles(query: web::Query<PaginationParams>, req: HttpRequest) -> HttpResponse {
    ...
    let total_items = match total_items_query.select(VehicleModel::as_select()).count().get_result::<i64>(conn) {
        Ok(count) => count,
        Err(e) => {
...
pub async fn get_vehicle_by_id(id: web::Path<String>, req: HttpRequest) -> HttpResponse {
